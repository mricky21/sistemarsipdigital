// Data dokumen arsip keluar
const documentsData = [
    {
        id: 1,
        name: "Surat Penawaran Kerjasama.pdf",
        category: "Administrasi",
        date: "18 Mar 2025",
        receiver: "PT Mitra Jaya",
        status: "approved",
        size: "1.2 MB",
        type: "pdf"
    },
    ...
    {
        id: 3,
        name: "Nota Dinas Pengajuan Cuti.xlsx",
        category: "SDM",
        date: "15 Mar 2025",
    ...
    },
    {
        ...
        category: "Penelitian",
        date: "14 Mar 2025",
        receiver: "Universitas Teknologi",
        status: "approved",
        size: "1.8 MB",
        type: "doc"
    },
    ...
    {
        id: 9,
        name: "Surat Pemberitahuan Libur Nasional.docx",
        category: "Umum",
        date: "5 Mar 2025",
        receiver: "Seluruh Karyawan",
        status: "approved",
        size: "0.9 MB",
        type: "doc"
    },
...
function applyFilters() {
    ...
    const filteredDocs = documentsData.filter(doc => {
        ...
        const matchesSearch = doc.name.toLowerCase().includes(searchTerm) || 
                             ...
                             doc.receiver.toLowerCase().includes(searchTerm);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('.btn-primary').addEventListener('click', function() {
        alert('Membuka form tambah arsip keluar baru');
    });
});